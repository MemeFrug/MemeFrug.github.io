...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this.Config = {
            ...
            g: 800, // Gravity 
            restitution: 0.1, // Set a restitution, a lower value will lose more energy when colliding, This Restitution is the wall
        ...
        this._Init = () => {
            ...
            const Game = this
            window.onwheel = (e) => {
                cubes.push(new Circle(Game, 10, 5, 0, 0, 50, 0.30, 20))
                cubes.push(new Circle(Game, 30, 5, 0, 0, 50, 0.30, 20))
                cubes.push(new Circle(Game, 60, 5, 0, 0, 50, 0.30, 20))
                cubes.push(new Circle(Game, 80, 5, 0, 0, 50, 0.30, 20))
                cubes.push(new Circle(Game, 100, 5, 0, 0, 50, 0.30, 20))
                cubes.push(new Circle(Game, 120, 5, 0, 0, 50, 0.30, 20))
            }

            setInterval(() => {
                cubes.push(new Circle(Game, 60, 30, 0, 0, 300, 0.10, 40))
            }, 1000);
            //----------------------------------
