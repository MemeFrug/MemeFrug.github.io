...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this.Config = {
            ...
            sideScroller: false,
            sideScrollPlayerFollowDelay: 0, // In milliseconds
            sideScrollPlayerPosition: 2, // This Variable Gets Divided By the screens space and minused by the player width and height divided by 2
        ...
        this._Init = () => {
            ...
            this.canvas.element.style.cursor = "none" // When Mouse Hover Over Canvas, Make It Invisible
        ...
        this.Draw = () => {
            ...
            if (this.Config.sideScroller) {
                this._.sideScrollPlayerFollowTime = this.Config.sideScrollPlayerFollowDelay
