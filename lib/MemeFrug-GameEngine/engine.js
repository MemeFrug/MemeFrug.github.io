...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this._Init = () => {
            ...
            //Debug
            const Square = _Classes.Square
            this.Debug.cubes = [
                new Square(this, 250, 50, 0, 50),
                new Square(this, 250, 300, 0, -50),
                new Square(this, 150, 0, 50, 50),
                new Square(this, 250, 150, 50, 50),
                new Square(this, 350, 75, -50, 50),
                new Square(this, 300, 300, 50, -50)
            ]
...
const _Classes = {
    Object: class {
        constructor(Game, x, y, vx = 0, vy = 0) {
            this.x = x
            this.y = y
            this.vx = vx;
            this.vy = vy;
    ...
    Square: class Square extends Object {
        constructor(Game, x, y, vx, vy, w = 50, h = 50) {
