...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this._Init = () => {
            ...
            //Debug
            this.Debug.cubes = [
                new Circle(this, 250, 50, 0, 50, 50, 20),
                new Circle(this, 250, 300, 0, -50, 50, 20),
                new Circle(this, 150, 0, 50, 50, 50, 20),
                new Circle(this, 250, 150, 50, 50, 300, 40),
                new Circle(this, 350, 75, -50, 50, 50, 20),
                new Circle(this, 300, 300, 50, -50, 300, 40)
            ]
 ...
 */
    class gameObject{
        constructor(Game, x, y, vx = 0, vy = 0, mass) {
            this.x = x
            this.y = y
            this.vx = vx;
            this.vy = vy;
    ...
    class Square extends gameObject {
        constructor(Game, x, y, vx, vy, mass, w = 50, h = 50) {
