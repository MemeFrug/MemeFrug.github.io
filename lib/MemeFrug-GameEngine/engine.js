...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this.Config = {
            ...
            g: 300, // Gravity 
            restitution: 0.2, // Set a restitution, a lower value will lose more energy when colliding, This Restitution is the wall
        ...
        //The Variables
        this._ = {
            timeFraction: 1, // The Speed Of Which the gameengine updates at
        ...
        this._Init = () => {
            ...
            function getCursorPosition(canvas, event) {
                ...
                const x = event.clientX - rect.left - scaleFitNative
                const y = event.clientY - rect.top - scaleFitNative
                console.log("x: " + x + " y: " + y)
                return {x:x,y:y}
            }
            const canvas = this.canvas.element
            const cubes = this.Debug.cubes
            const Game = this
            canvas.addEventListener('mousedown', function(e) {
                const pos = getCursorPosition(canvas, e)
                cubes.push(new Circle(Game, pos.x, pos.y, 0, 0, 50, 0.90, 20))
            })

            this.Debug.cubes = [
                new Circle(this, 250, 50, 0, 50, 50, 0.90, 20),
                new Circle(this, 250, 300, 0, -50, 50, 0.90, 20),
                new Circle(this, 150, 0, 50, 50, 50, 0.90, 20),
                new Circle(this, 250, 150, 50, 50, 300, 0.5, 40),
                new Circle(this, 350, 75, -50, 50, 50, 0.90, 20),
                new Circle(this, 700, 300, 50, -50, 300, 0.5, 40),
                new Circle(this, 550, 50, 0, 50, 50, 0.90, 20),
                new Circle(this, 780, 300, 0, -50, 50, 0.90, 20),
                new Circle(this, 760, 0, 50, 50, 50, 0.90, 20),
                new Circle(this, 120, 150, 50, 50, 300, 0.5, 40),
                new Circle(this, 460, 75, -50, 50, 50, 0.90, 20),
                new Circle(this, 100, 300, 50, -50, 300, 0.5, 40)
            ]
            //----------------------------------

            this.canvas.addEvents() // Add The Necessary Events Onto The Canvas
            this.Update() // Call the Update Function, Which Starts The Loop
        }

        this.detectEdgeCollisions = () => {
            const restitution = this.Config.restitution
            const canvasWidth = this.Config.WorldSize.x
            const canvasHeight = this.Config.WorldSize.y
            let obj;
            for (let i = 0; i < this.gameObjects.length; i++)
            {
                ...
                if (obj instanceof Circle) {
                    ...
                    if (obj.y - obj.r <= 0){ // top
                        obj.vy = Math.abs(obj.vy) * restitution;
                        obj.y = obj.r;
                    } else if (obj.y + obj.r >= canvasHeight){ // bottom
                        obj.vy = -Math.abs(obj.vy) * restitution;
        ...
        this.detectCollisions = () => {
            ...
            for (let i = 0; i < gameObjects.length; i++)
            {
                ...
                for (let j = i + 1; j < gameObjects.length; j++)
                {
                    ...
                    }else if (obj2 instanceof Circle && obj2 instanceof Circle) {
        ...
        this.Update = (timeStamp) => {
            ...
            this.detectCollisions() // Call the detectCollisions Function to Update Collisions
 ...
 */
    class gameObject{
        constructor(Game, x, y, vx = 0, vy = 0, mass, restitution = 0.9) {
            this.x = x
            this.y = y
            this.vx = vx;
            this.vy = vy;
    ...
    class Square extends gameObject {
        constructor(Game, x, y, vx, vy, mass, restitution, w = 50, h = 50) {
            super(Game, x, y, vx, vy, mass, restitution)
            this.w = w
            this.h = h
            this.isColliding = false;
    ...
    class Circle extends gameObject {
        constructor(Game, x, y, vx, vy, mass, restitution, r = 30) {
            super(Game, x, y, vx, vy, mass, restitution)
            this.r = r
