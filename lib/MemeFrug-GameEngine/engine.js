...
class _ {
    constructor(_nameOfGame = undefined) {
        ...
        this._Save = { // The Save Object
             ...
             * @param {*} SaveFile The Save File (A Object like so: {})
             */
            SetSave: (SaveFile) => {
        ...
        this.Update = (deltaTime) => {
            ...
            if (!this.Config.Playing) { // If Not Playing Then Dont Update, But Still Draw
            ...
            for (let i = 0; i < this.functionLoop.length; i++) { //For Every Single Item In the FunctionLoop
                ...
                if (element.Update != undefined) element.Update() // If The Update Function Exists, Call it
            }
