    ...
    Draw: () => {
        ...
        if (ENGINE.Config.sideScroller) {
            ...
            if (!LocalPlayer.error) {
                ...
                ENGINE.VARIABLES.Cam.y += (-LocalPlayer.y * ENGINE.Config.cameraScale - LocalPlayer.h / 2 + ENGINE.Config.sideScrollPlayerPositionOffset.y + nativeHeight / ENGINE.Config.sideScrollPlayerPosition - ENGINE.VARIABLES.Cam.y) * ENGINE.Config.cameraFollowSpeed * ENGINE.VARIABLES.oldDeltaTime
